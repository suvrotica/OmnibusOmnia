...
It won't. Everything I have is digital, and unless you're noticed, you're deleted.
42br
...
42br
To be politically correct would be akin to feigning blindness or several incapacities, for which there are many willing, healthy volunteers in India. They are elected in a theater that fills the building called the parliament, a printing press, and a stage, and the actors are all diligently playing their roles as jesters on the provided theater stage, secure without the existential angst outside. Whatever is written and implemented by the rich and powerful is printed on this printing press, and the people of India are allowed to choose the punctuation on a promise proof that's never printed but held on year after year as something to be desired but yet to be arrived at.
42br
But unfortunately, it's blood loss in vain. I represent a category that doesn't mean any harm. Think of my blood loss as a waste of time. I am just a mere speck of frivolity that still shits his pants when hit with the most common stomach flu. How can I be a danger to anyone, necessitating a broken nose? The world has become so incongruous that even the harshest, luridest, satirical exaggeration of it fails to deliver the bitter irony of the reality I see around me. And people are so resistant to the truth that a comical inversion only serves to elicit a superficial, obvious reaction, thus failing to deliver the punch. In effect, cringe stays cringe, unable to deliver the payload because that requires a thinking mind, perhaps one that's a little bit mad.
42br
