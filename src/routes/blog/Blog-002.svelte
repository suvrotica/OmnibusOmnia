...
<article class="svg">
	...
	<article >
<p>You've seen Delhi's condition. This is only because the cameras are there. The issues are endemic, but we don't see them since the cameras are artfully diverted to the emperor's new clothes.
<br />
