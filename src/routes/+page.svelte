...
where even a donkey—I hate to demean the creature's good reputation in sharing our gravity burden—can pay a sum of money to become a teacher, the amount determining the level, whether he brays nursery rhymes or quantum shit. Or, for that matter, you as an overconfidant wackjob need to know even less than a braying donkey to be an elected leader, a grinning imbecile; as long as you can stridently contradict the truth and loudly, rinse, and repeat unabashedly with wanton disregard for consequences, you have what it takes. At least an apprentice to a goon, and then you move up the ladder—an assured system, I'm told.
42br
